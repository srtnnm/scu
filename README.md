...
* `--force-versions`
  ...
  Enables version fetching (was disabled by default in commit [a0c0bada](https://gitlab.com/charidot/scu/-/commit/a0c0badaa2b506496558797c3a02957ece0f3ff9#9541a669da5368e41d92810535106685569e34d0_54_52) due to bad performance)
...
``` shell
$ git clone --depth=1 https://gitlab.com/charidot/scu
$ cd scu
$ cargo build --release
```
